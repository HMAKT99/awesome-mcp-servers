...
- <img src="https://github.com/HMAKT99.png" height="14"/> [ERABI](https://github.com/HMAKT99/Erabi) - Open intent exchange that gives any agent a portable, verifiable track record: one-command Ed25519 identity, reputation-ranked discovery (rankings cannot be bought), signed sponsorship disclosures, and dual-signed outcomes on a publicly auditable ledger. Zero-config: `npx -y erabi-mcp` joins the live network.
